...
On March 24th, new versions of `litellm` were uploaded to PyPI \- `litellm` 1.82.7 and 1.82.8. This version contains a malicious payload in both `proxy_server.py` file and `litellm_init.pth`. This compromise is probably a direct result of `litellm`‘s usage of `trivy` [in their CI/CD](https://github.com/BerriAI/litellm/blob/9343aeefca37aa49a6ea54397d7615adae5c72c9/ci_cd/security_scans.sh#L80), which was also compromised recently. 
